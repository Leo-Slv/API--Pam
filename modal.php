...
<!-- Modal de Alterar 
<div id="fadeA" class="hide"></div>
  <section id="modalA" class="bg-slate-900 hide w-6/12 p-4 rounded-lg border-white border-4">
    <header id="modal-header">
      <tittle class="text-white text-2xl font-bold">
        Alterar
      </tittle>
  ...
  <!-- Modal de Deletar 
<div id="fadeD" class="hide"></div>
  <section id="modalD" class="bg-slate-900 hide w-6/12 p-4 rounded-lg border-white border-4">
    <header id="modal-header">
      <tittle class="text-white text-2xl font-bold">
        Deletar
      </tittle>
